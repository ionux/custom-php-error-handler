 ...
 *
 * @license Copyright 2014-2016 Rich Morgan <rich@richmorgan.me>, MIT License 
...
function MyErrHandler($errno, $errstr, $errfile, $errline, $errcontext, $errbacktrace = false, $bypassinternal = true, $errsavefile = 'php_errors.log')
{
    ...
    if ($errsavefile == '') {
        $filename = date("Ymd") . '-' . 'php_errors.log';
    } else {
        $filename = date("Ymd") . '-' . $errsavefile;
    }
    ...
    switch ($errno) {
        ...
        case E_ERROR:
            ...
            $error_string .= "  Error on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
        ...
        case E_WARNING:
            ...
            $error_string .= "  Warning on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_PARSE:
            ...
            $error_string .= "  Parse exception on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_NOTICE:
            ...
            $error_string .= "  Notice on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_CORE_ERROR:
            ...
            $error_string .= "  Core error on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_CORE_WARNING:
            ...
            $error_string .= "  Core warning on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_COMPILE_ERROR:
            ...
            $error_string .= "  Compile error on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_COMPILE_WARNING:
            ...
            $error_string .= "  Compile warning on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_USER_ERROR:
            ...
            $error_string .= "  User error on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_USER_WARNING:
            ...
            $error_string .= "  User warning on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_USER_NOTICE:
            ...
            $error_string .= "  User notice on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_STRICT:
            ...
            $error_string .= "  Strict exception on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_DEPRICATED:
            ...
            $error_string .= "  Depricated exception on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_USER_DEPRICATED:
            ...
            $error_string .= "  User depricated exception on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        case E_RECOVERABLE_ERROR:
            ...
            $error_string .= "  Recoverable error on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
        ...
        default:
            ...
            $error_string .= "  Unknown error on line $errline in file $errfile";
            $error_string .= ", PHP " . PHP_VERSION . " (" . PHP_OS . ")\r\n";
            $error_string .= "  The variable context was: " . var_export($errcontext, true) . "\r\n";
            if ($errbacktrace == true) {
                $error_string .= "  BACKTRACE: " . var_export(debug_backtrace(), true) . "\r\n";
